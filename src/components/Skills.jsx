...
import {
    ...
    SiTypescript, SiNetlify, SiMongodb, SiExpress, SiPostman, SiVercel, SiAwsamplify, SiAntdesign 
} from "react-icons/si";
import "./skills.css";
...
export const Skills = () => {
    ...
    return (
        <section id="skillsID" className="section-skills" >
            <div className="main-skills">
                ...
                <div className="skills-cont">
                        ...
                        <div className="skill"  >
                            ...
                            <p className="skill-ptag">React Native</p>
                        </div>
                        <div className="skill"  >
                        ...
                        <div className="skill"  >
                            ...
                            <p className="skill-ptag">Antdesign</p>
                        </div>
                        <div className="skill"  >
                ...
                <div className="skills-cont">
                        ...
                        <div className="skill"  >
                            ...
                            <p className="skill-ptag">Vercel</p>
                        </div>
                        <div className="skill"  >
                            <div className="badge chakra">
                                <SiAwsamplify />
                            </div>
                            <p className="skill-ptag">Awsamplify</p>
                        </div>
                    </div>
            </div>
        </section>
